...
/**   
  * @文件名: MP3ConvertPCM.java 
  * @包 com.baidu.ai.aip.audio 
  * @描述: TODO(用一句话描述该文件做什么) 
  * @作者：xushaunglu   
  * @创建时间 2019年8月12日 下午7:29:22 
  * @版本 V2.1  
  */
...
public class MP3ConvertPCM {
	...
	public static void main(String[] args) throws Exception {
		mp3Convertpcm("E:\\workspace1\\xushuanglu-baidu-ai\\src\\main\\java\\com\\baidu\\ai\\aip\\audio\\1565660330522.mp3","d:\\test.pcm");
	}
}
